...
<Image src={typescriptImage} alt="TypeScript meme" />
...
<Image src={typescriptErrorImage} alt="TypeScript error meme" />
...
<Image class="small" src={johnSnowImage} alt="John Snow" />
...
<Image src={figmaImage} alt="Figma VS code plugin" />
