...
<div class="blog-header site-section">
...
<Picture image={typescriptImage} alt="TypeScript meme" />
...
<Picture image={typescriptErrorImage} alt="TypeScript error meme" />
...
<Picture class="small" image={johnSnowImage} alt="John Snow" />
...
<Picture image={figmaImage} alt="Figma VS code plugin" />
